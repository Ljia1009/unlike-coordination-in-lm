...
def main():
    # --- Configuration ---
    FILTERED_DATA_FILE = "/root/autodl-tmp/corpus/train_downsampled.corpus"
    TOKENIZER_PATH = "/root/unlike-coordination-in-lm/models/original_tokenizer"
    MODEL_OUTPUT_PATH = "/root/autodl-tmp/models/original_gpt2_model"
