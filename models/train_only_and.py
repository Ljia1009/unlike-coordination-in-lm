...
def main():
    # --- Configuration ---
    FILTERED_DATA_FILE = "/root/autodl-tmp/corpus/filtered_dataset_only_and_downsampled.txt" 
    TOKENIZER_PATH = "/root/unlike-coordination-in-lm/models/filtered_and_tokenizer"
    MODEL_OUTPUT_PATH = "/root/autodl-tmp/models/filtered_and_gpt2_model"
